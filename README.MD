...
*Requires `wget --no-check-certificate -qO /tmp/install_netwatchdta.sh "https://raw.githubusercontent.com/panoc/NetWatchdta/refs/heads/main/install_netwatchdta_wrt.sh" && sh /tmp/install_netwatchdta.sh`.
