...
*No sudo required. Requires `wget`. Requires `curl` only if you have problem with default uclient-fetch implementation and/or you want to manually switch to `curl`.*
